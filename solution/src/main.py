...
def generate_cohort_report(customers_csv_reader, orders_csv_reader, output_csv_writer, timezone: str, max_weeks: int):
...
def main():
    (customers_file_path, orders_file_path, output_file_path, timezone, max_weeks) = parse_argv(sys.argv[1:])
