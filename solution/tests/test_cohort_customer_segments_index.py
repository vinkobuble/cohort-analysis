...
class TestCohortCustomerRangeIndex(TestCase):
    ...
    def test_add_customer(self):
        ...
        self.assertEqual(cohort_index.CustomerIdSegmentsNode(10),
                         cohort_customer_index.cohort_id_to_customer_id_ranges[self.cohort_id].root_node)

        cohort_customer_index.add_customer(11, self.cohort_date)
        self.assertIn(self.cohort_id, cohort_customer_index.cohort_id_to_customer_id_ranges)
        self.assertEqual((10, 11),
                         cohort_customer_index.cohort_id_to_customer_id_ranges[
        ...
        self.assertEqual((9, 11),
                         cohort_customer_index.cohort_id_to_customer_id_ranges[
                             self.cohort_id].root_node.customer_id_segment)
        self.assertEqual(1,
                         len(cohort_customer_index.cohort_id_to_customer_id_ranges[self.cohort_id].root_node.subtree))
    ...
    def test_build_cohort_index_five_rows_two_overlapping_cohorts(self):
        ...
        self.assertTupleEqual((35410, 35410),
                              index.cohort_id_to_customer_id_ranges[201527].root_node
                              .customer_id_segment)
        self.assertEqual(1, len(index.cohort_id_to_customer_id_ranges[201527].root_node.subtree))
        self.assertTupleEqual((35413, 35413),
                              index.cohort_id_to_customer_id_ranges[201527].root_node.subtree
                              [0].customer_id_segment)
        self.assertTupleEqual((35411, 35412),
                              index.cohort_id_to_customer_id_ranges[201533].root_node
                              .customer_id_segment)
        self.assertEqual(1, len(index.cohort_id_to_customer_id_ranges[
                                    201533].root_node.subtree))
        self.assertTupleEqual((35414, 35414),
                              index.cohort_id_to_customer_id_ranges[201533].root_node.subtree
                              [0].customer_id_segment)
    ...
    def test_build_cohort_index_five_rows_one_merged_cohort(self):
        ...
        self.assertEqual(0, len(index.cohort_id_to_customer_id_ranges[201527].root_node.subtree))
